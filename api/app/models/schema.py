...
class VideoParams(BaseModel):
    ...
    video_source: Optional[str] = "pixabay"
                    ...
                    "files": [
                        {
                            "name": "output013.mp3",
                            "size": 1891269,
                            "file": "/Aeterna/resource/songs/output013.mp3",
                        }
                    ]
                },
            },
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "status": 200,
                "message": "success",
                "data": {"file": "/Aeterna/resource/songs/example.mp3"},
            },
        }
                    ...
                    "files": [
                        {
                            "name": "example.mp4",
                            "size": 12345678,
                            "file": "/Aeterna/resource/videos/example.mp4",
                        }
                    ]
                },
            },
