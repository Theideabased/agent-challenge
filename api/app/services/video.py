...
def generate_video(
    ...
    # Upstream issue #217 reference: PermissionError: [WinError 32] The process cannot access the file because it is being used by another process: 'final-1.mp4.tempTEMP_MPY_wvf_snd.mp3'
